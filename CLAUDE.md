...
## Core files
- `multiply_shared.js` — shared module (sessions, dates, SVI, preaching, swap modal, etc.). Loaded by every tool as `multiply_shared.js?v=N` (**currently v=11** — bump ALL 21 consumers together, Inv #138).
